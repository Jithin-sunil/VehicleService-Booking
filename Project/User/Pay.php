...
ob_start();
    ...
    $SelQry = "SELECT * FROM tbl_packagebooking p inner join tbl_package pa on pa.package_id=p.package_id WHERE packagebooking_id =".$_GET['pbid'];
    $res = $Con->query($SelQry);
    if ($res && $res->num_rows > 0) {
        $row = $res->fetch_assoc();
		$amt=$row['package_amount'] ;
    
}

if (isset($_POST["btn_pay"])) {
   
        $update = "UPDATE tbl_packagebooking SET packagebooking_status='3' WHERE packagebooking_id = " . $_GET["pbid"];
                                            ...
                                            <table cellspacing="20">
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <input type="text" style="width: 185px;" id="credit-card"
                                                            ...
                                                            title="Enter Correct Card Number" maxlength="19"
                                                ...
                                                <tr>
                                                    <td colspan="4" align="center"><input type="submit"
                                                            value="Make Payment" name="btn_pay" class="button-pay"></td>
                                                </tr>
                                            </table>
                                </td>
                            </tr>
